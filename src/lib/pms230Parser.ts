...
function rowM2(r: { largeur: number; longueur: number; schedLites: number }): number {
...
function summariseSchedules(records: PMS230Record[]): ScheduleSummary[] {
...
export function parsePMS230(textOrPayload: string | PastePayload): PMS230ParseResult {
  const html =
...
export function mergePMS230(
  prev: PMS230ParseResult | null | undefined,
  next: PMS230ParseResult,
): PMS230ParseResult {
