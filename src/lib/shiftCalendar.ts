...
import type { Poste, ShiftKey, ShiftType } from '../types';

export const CYCLE = 'NRRRMMAANNNRRMMAAANNRRMMMAAN'.split('') as ShiftKey[]; // length 28
...
export const POSTES: readonly Poste[] = ['A', 'B', 'C', 'D'];
export const POSTE_OFFSET: Record<Poste, number> = { C: 0, B: 7, A: 14, D: 21 };
